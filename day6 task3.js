...
//  const sum = (a, b) =>a + b;
const sum = num.reduce((sum, num) => sum + num); 
// Since we are using reduce method we dont have to declare the sum before,and in reduce method 1st parameter acts as accumulator and second is the current elememt
console.log(sum);